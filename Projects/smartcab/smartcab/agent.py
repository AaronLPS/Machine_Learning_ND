...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.templateQ = dict((k,0.0) for k in self.valid_actions)
        for stateTuple in itertools.product(*self.stateDef):
            self.Q[stateTuple] = self.templateQ.copy()
    ...
    def createQ(self, state):
        ...
        if not state in self.Q:
            self.Q[state] = self.templateQ.copy()
